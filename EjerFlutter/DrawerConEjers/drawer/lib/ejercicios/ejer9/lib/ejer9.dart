      ...
      body: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          if (index < 2) {
            ...
            return Container(
              color: index.isEven ? Colors.grey[100] : Colors.grey[400], // Color container
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      height: 90,
                      child:
                          SwitchButton(), // Crear instancia aquí
                    ),
                  ],
                ),
              ),
            ...
            onPressed: () {
              ...
              showDialog( 
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    title: Text('Alerta'),
                    content: Text('Botón ${index ?? ''} presionado'), // Contenido de la alerta (numero boton)
                    actions: [
                      TextButton(
                        onPressed: () {
...
class _BotonFlotanteLinternaState extends State<BotonFlotanteLinterna> {
  bool _isOn = false; // Creo un boolean inicial para saber que no esta presionado
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton(
      onPressed: () {
        setState(() {
          _isOn = !_isOn; // El set del estado hace lo contrario al boolean es decir true
        });
      },
      child: _isOn ? Icon(Icons.flashlight_on) : Icon(Icons.flashlight_off), // Si no es presionado cambia de icono y viceversa
    );
  }
}
